(function () {
  ...
  $("#periodic-table td.element dd").each(setup_element_value);

  $('#periodic-table td.element dd[itemprop="atomic_weight"]').each(
    format_atomic_weight
  );
  ...
  $("#periodic-table td.properties dt").click(on_property_click);

  $("#periodic-table td.properties dd").click(select_text);

  // showcase cell

  $('#periodic-table td.showcase dd[data-id="name"]').click(select_text);

  $("#periodic-table td.showcase dd.property span.value").click(select_text);
}.call(this));
